...
<!-- <div id="content" class="app-content"> -->
    ...
    <div class="hbox hbox-auto-xs hbox-auto-sm">
        <div class="bg-light lter wrapper-md">
            <h1 class="entry-title m-n font-thin text-black l-h"><span class="title-icons"><i data-feather="alert-triangle"></i></span><?php _me
                ("404,您访问的页面不存在！")
                ?></h1>
        ...
        <div class="wrapper-md">
            ...
            <h2 class="text-center"><i data-feather="coffee"></i> 累了吧！玩个游戏放松一下，敲击空格开始</h2>
  <style>
#main-content{
    height: 0;
}
...
.icon-offline {
    content: -webkit-image-set(url(//cdn.jsdelivr.net/gh/kaygb/blog-images/static_css/konglong/100-error-offline.png) 1x, url(//cdn.jsdelivr.net/gh/kaygb/blog-images/static_css/konglong/200-error-offline.png) 2x);
    position: relative;
}
.hidden {
    display: none;
...
<div id="t" class="offline">
    ...
    <div id="main-frame-error" class="interstitial-wrapper">
        ...
        <div id="offline-resources">
            <img id="offline-resources-1x" src="//cdn.jsdelivr.net/gh/kaygb/blog-images/static_css/konglong/100-offline-sprite.png">
            <img id="offline-resources-2x" src="//cdn.jsdelivr.net/gh/kaygb/blog-images/static_css/konglong/200-offline-sprite.png">
...
<script src="//cdn.jsdelivr.net/gh/kaygb/blog-images/static_css/konglong/index.js"></script>
<script>
console.log('\n' + ' %c 404 恐龙游戏 by 风也 ' + ' %c https://eas1.cn/posts/119.html ' + '\n' + '\n', 'color: #fadfa3; background: #030307; padding:5px 0;', 'background: #fadfa3; padding:5px 0;');
